  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <main className="flex-1 md:ml-64 flex flex-col min-h-screen">
        {/* Top Header */}
        <header className="h-16 sticky top-0 z-40 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-[#e2e2e2] dark:border-[#222222] flex items-center justify-between px-4 md:px-8">
          <div className="flex items-center gap-4">
            <button className="md:hidden p-2 rounded-md hover:bg-[#f9f9f9] dark:hover:bg-[#111111]" onClick={() => setIsSidebarOpen(true)}>
            ...
            <div className="relative group hidden sm:block">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-12 py-1.5 bg-[#f9f9f9] dark:bg-[#111111] border border-[#e2e2e2] dark:border-[#222222] rounded-md text-sm focus:ring-1 focus:ring-black dark:focus:ring-white transition-all w-48 md:w-64"
              />
